...
def identify(data, annotated_data):
    ...
    #print("Checking for bank account information...")
    for line in data:
    ...
    #print("Checking for vehicle license number, mobile number, dates or personal number...")
    for line in data:
    ...
    #print("Checking family relations...")
    for line in data:
    ...
    #print("Checking friends and siblings in plural...")
    for line in data:
    ...
    #print("Checking university names...")
    ...
    for i in data: #for sentence/line in data
    ...
    #print("Checking Swedish cities...")
    #No implementation of the Sparv annotation check since it prevents findings instead of helping
    for i in data:
    ...
    #print("Checking Swedish streets...")  
    #No implementation of the Sparv annotation check since it prevents findings instead of helping    
    for i in data:
    ...
    #print("Checking men's first names...")
    ...
    #print("Checking women's first names...")
    for i,j in enumerate(data):                   
    ...
    #print("Checking neutral first names...")
    for i,j in enumerate(data):                   
    ...
    #print("Checking genetive men's first names...")  
    for i,j in enumerate(data):
        for key, value in dict_fornamn_man.items():
            value_s = value[1] + 's'
            if value_s == j:
    ...
    #print("Checking genitive women's first names...")
    for i,j in enumerate(data):
        for key, value in dict_fornamn_kvn.items():
            value_s = value[1] + 's'
            if value_s == j:
    ...
    #print("Checking genitive neutral first names...")    
    for i,j in enumerate(data):
        for key, value in dict_neutral_namn.items():
            value_s = value[1] + 's'
            if value_s == j:
